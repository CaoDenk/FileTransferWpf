...
namespace FileTransfer.Models
{
    internal class RecvHandle
    {
        ...
        public string GetFileName()
        {
            ...
            //int len = jsonObject.getInt("filesize");
            return fileName;
             //"";
        }
       ...
       // }
        ...
        public async void SaveFile(string filepath,Socket client,Window parent)
        {
            MyFiles save = new MyFiles();
            //string path= save.save(parent, filepath);
            ...
            do
            {
                ...
                type=BitConverter.ToInt32(buf);
                if (type==InfoHeader.CONTINUE_RECV)
                {
            ...
            Dispatcher.UIThread.Post(
                       () =>
                       {
                           MyMessage.show("info", "recv finished!");
                       }
                       );
